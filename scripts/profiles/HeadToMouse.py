...
bMouseLookXEnabled = True
bMouseLookYEnabled = True
...
FULLY_DISABLED = [0.1, 0.1]  # Effectivly disables deadzone when mouselook is enabled
LEFT_DIRECTION  = hDirection(0,-1)  
RIGHT_DIRECTION = hDirection( 0, 1) 
UP_DIRECTION    = hDirection(0,-1) 
DOWN_DIRECTION  = hDirection( 0, 1) 
...
vrToMouse.mouseSensitivityX = 354
vrToMouse.mouseSensitivityY = 354
